...
def draw_spn(spn: SPN, file="spn_default", show=True):
    ...
    spn_graph.attr('node', forcelabels='true')
    ...
    for transition in spn.transitions:
        if transition.t_type == "T":
            ...
            spn_graph.node(transition.label, shape='rectangle', style='filled', color='black', label='', xlabel=transition.label, height='0.2', width='0.6', fixedsize='true')
